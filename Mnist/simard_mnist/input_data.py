...
class DataSet(object):
  ...
  def images(self, images):
    if images.shape == self._images.shape:
      self._images = images
    else:
       raise ValueError("invalid set of images")
  @property
...
# 读取训练数据
def read_data_sets(train_dir, fake_data=False, one_hot=False, dtype=tf.float32, validation_size=5000):
